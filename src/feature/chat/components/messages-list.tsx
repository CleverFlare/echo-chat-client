              ...
              <AnimatePresence initial={false}>
                {contact?.isTyping && (
                  ...
                  >
                    ...
                    >
                      <div className="size-2 rounded-full bg-neutral-200 animate-murcery" />
                      <div className="size-2 rounded-full bg-neutral-200 animate-murcery delay-200" />
                      <div className="size-2 rounded-full bg-neutral-200 animate-murcery delay-400" />
                    </motion.div>
                  </motion.div>
                )}
              </AnimatePresence>
